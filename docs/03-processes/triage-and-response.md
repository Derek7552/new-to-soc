...
把一段时间内的所有事件按统一维度归类，就能看出**哪类问题在收敛、哪类问题在新增**——这正是下一阶段调优该聚焦的重点。举一反三，从一个问题优化一类问题。
...
- 没有事件机会怎么办？让蓝军/红队**主动制造机会**

> 不要只看友商笑话，要拆解原因映射到自家。系统化的运营心法详见 [安全运营方法论](security-operations-methodology.md)。
